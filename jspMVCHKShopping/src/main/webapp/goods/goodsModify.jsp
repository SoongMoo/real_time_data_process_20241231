...
<table border=1 align="center" width="600">
	...
	<tr><th width="150" >상품번호</th>
		<td><input type="text" name="goodsNum" value="" readonly="readonly"></td></tr>
	<tr><th width="150" >상품명</th>
		<td><input type="text" name="goodsName" value=""></td></tr>
	<tr><th>상품가격</th>
		<td><input type="text" name="goodsPrice" value=""></td></tr>
	<tr><th>상품설명</th>
