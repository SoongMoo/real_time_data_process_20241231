...
import com.hk.repository.StockRepository;
    ...
    private static class ClientHandler implements Runnable {
        ...
        public void run() {
            try {
                ...
                //if (transaction.get종목코드().contains("001250")) { //475150 , 005930
                    ...
                    //System.out.println(buffer.getString(70, StandardCharsets.UTF_8.newDecoder()));
                    //this.endTime = System.currentTimeMillis();
                    //System.out.print("-- Thread started at: " + startTime);
                    //System.out.println("-- Thread ended at: " + endTime);
